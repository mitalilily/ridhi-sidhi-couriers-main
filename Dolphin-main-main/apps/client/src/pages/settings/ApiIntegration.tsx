...
const ApiIntegration = () => {
  ...
  const handleDownloadDocumentation = () => {
    ...
    link.download = 'RS Express-Enterprises-API-Documentation-v1.pdf'
      ...
      <Stack spacing={4}>
        <Stack direction="row" justifyContent="space-between" alignItems="center">
          <PageHeading
            ...
            subtitle="Manage API keys and webhook subscriptions inside the RS Express developer workspace."
            eyebrow="Developer"
          />
          <Button
            variant="outlined"
